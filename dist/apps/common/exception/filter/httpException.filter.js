...
const base_exception_1 = require("../CustomExceptions/base.exception");
const unknown_exception_1 = require("../CustomExceptions/unknown.exception");
let CustomExceptionFilter = class CustomExceptionFilter {
    constructor(httpAdapterHost) {
        ...
        const exception = (() => {
            ...
            return new unknown_exception_1.UnknownException({
                title: error.name,
                message: error.message,
                raw: error,
            });
